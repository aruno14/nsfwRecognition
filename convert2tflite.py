...
parser.add_argument("--model_folder", type=str, help="Input model folder path", default="nsfw_model_gray")
parser.add_argument("--output", type=str, help="Output tflite file", default="nsfw_model_gray.tflite")
